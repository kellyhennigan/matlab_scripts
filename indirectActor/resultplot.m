function [] = resultplot(reward, choice, numChoice, learningRate, exploration)
...
[negLogLike, td, exploitation, probs, m] = indirectActorIndv(exploration, reward, choice, numChoice, learningRate);
