...
% Subject directories
subs = getSASubjects('fmri');
% indx = logical(1:21);
% indx(1:14)=false;
% % indx(15:21)=false;
% subs = subs(indx);
% subs = {'sa30','sa31','sa32','sa33','sa34'};
% % subs = { 'ak090724','am090121','db061209','er100302','hh100622',...
%     'ka040923','ns090526','rb080930','rfd100302','sr090327'};

% % Names of ROIs - no file extensions
% ROI1 = {'striatum_ind1_of_6','striatum_ind2_of_6','striatum_ind3_of_6',...
%    'striatum_ind4_of_6','striatum_ind5_of_6','striatum_ind6_of_6'};
