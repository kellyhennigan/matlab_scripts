function [fa, md, ad, rd, cl, SuperFiber, fgClipped] = ...
    dtiComputeDiffusionPropertiesAlongFG_kh(fg, dt, roi1, roi2, numberOfNodes, dFallOff)
...
% kh, just commented out the dtiClipFiberGroupToROIs (lines 48-51) command 
% bc its not necessary for my pathways
